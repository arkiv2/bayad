...
$fields = [
    'author_name' =>            ['Arki Valencia II',             '',                                                ''],
    'author_github_username' => ['arkiv2',  '<username> in https://github.com/username',       ''],
    'author_email' =>           ['arvalencia@gbox.adnu.edu.ph',    '',                                                ''],
    'author_twitter' =>         ['@arkiv2', '',                                                '@{author_github_username}'],
    'author_website' =>         ['http://sigmalambdaphi.me',          '',                                                'https://github.com/{author_github_username}'],

    'package_vendor' =>         ['arkiv2',        '<vendor> in https://github.com/vendor/package',   '{author_github_username}'],
    'package_name' =>           ['bayad',          '<package> in https://github.com/vendor/package',  ''],
    'package_description' =>    ['Braintree Service Provider for Laravel',   '',                                     ''],
